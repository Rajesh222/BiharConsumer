...
public class Constants {
	...
	public static final String ERROR_HEADER ="Your application getting error";
	public static final String ERROR_BODY = "<html><body><p> Dear Customer,<br/> <br/> Your Error is :- <b>EEROR_VALUES<br><br>Thank you,<br>Team Digital Bihar</p></body></html>";
